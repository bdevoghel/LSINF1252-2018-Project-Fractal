...
test_time:
	...
	@echo 'Executing time for [./main -d inputs/lvl3_time_consuming.txt o.bmp] :'
	@time ./main -d inputs/lvl3_time_consuming.txt o.bmp
	@echo 'Executing time for [./main -d --maxthreads 5 inputs/lvl3_time_consuming.txt o.bmp] :'
	@time ./main -d --maxthreads 5 inputs/lvl3_time_consuming.txt o.bmp
